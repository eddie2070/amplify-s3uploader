...
const helpers = require('./helpers-b39e99cc.js');
const authHelpers = require('./auth-helpers-beba6ea3.js');
    ...
    async confirmSignUp(event) {
        ...
        try {
            ...
            if (this._signUpAttrs && this._signUpAttrs.password && this._signUpAttrs.password !== '') {
                ...
                await authHelpers.handleSignIn(this.userInput, this._signUpAttrs.password, this.handleAuthStateChange);
            }
            else {
...
const AmplifySignIn = class {
    ...
    async signIn(event) {
        ...
        await authHelpers.handleSignIn(username, this.signInAttributes.password, this.handleAuthStateChange);
        this.loading = false;
    }
    buildDefaultFormFields() {
