...
const componentFieldMapping = {
    username: (ff) => (index.h("amplify-username-field", { label: ff.label, placeholder: ff.placeholder, required: ff.required, handleInputChange: ff.handleInputChange, value: ff.value, inputProps: ff.inputProps, disabled: ff.disabled })),
    ...
    email: (ff) => (index.h("amplify-email-field", { label: ff.label, placeholder: ff.placeholder, required: ff.required, handleInputChange: ff.handleInputChange, value: ff.value, inputProps: ff.inputProps, disabled: ff.disabled })),
    ...
    phone_number: (ff) => (index.h("amplify-phone-field", { label: ff.label, placeholder: ff.placeholder, required: ff.required, handleInputChange: ff.handleInputChange, value: ff.value, inputProps: ff.inputProps, disabled: ff.disabled, dialCode: ff.dialCode })),
    default: (ff) => (index.h("amplify-form-field", { label: ff.label, type: ff.type, placeholder: ff.placeholder, required: ff.required, handleInputChange: ff.handleInputChange, value: ff.value, inputProps: ff.inputProps, disabled: ff.disabled })),
};
...
const AmplifyEmailField = class {
    ...
    render() {
        return (index.h("amplify-form-field", { fieldId: this.fieldId, label: core.I18n.get(this.label), placeholder: core.I18n.get(this.placeholder), type: "email", required: this.required, handleInputChange: this.handleInputChange, value: this.value, inputProps: this.inputProps, disabled: this.disabled }));
    }
};
...
const AmplifyPasswordField = class {
    ...
    render() {
        return (index.h("amplify-form-field", { type: "password", fieldId: this.fieldId, label: core.I18n.get(this.label), placeholder: core.I18n.get(this.placeholder), hint: this.hint, required: this.required, handleInputChange: this.handleInputChange, value: this.value, inputProps: this.inputProps, disabled: this.disabled }));
    }
};
...
const AmplifyPhoneField = class {
    ...
    render() {
        return (index.h("div", null, index.h("amplify-form-field", { label: core.I18n.get(this.label), hint: this.hint, required: this.required }, index.h("div", { class: "phone-field", slot: "input" }, index.h("amplify-country-dial-code", { dialCode: this.dialCode, handleInputChange: this.handleInputChange }), index.h("amplify-input", { fieldId: this.fieldId, type: "tel", handleInputChange: this.handleInputChange, placeholder: core.I18n.get(this.placeholder), name: this.fieldId, value: this.value, inputProps: this.inputProps, disabled: this.disabled })))));
    }
};
...
const AmplifyUsernameField = class {
    ...
    render() {
        return (index.h("amplify-form-field", { fieldId: this.fieldId, label: core.I18n.get(this.label), placeholder: core.I18n.get(this.placeholder), required: this.required, handleInputChange: this.handleInputChange, value: this.value, inputProps: this.inputProps, disabled: this.disabled }));
    }
};
