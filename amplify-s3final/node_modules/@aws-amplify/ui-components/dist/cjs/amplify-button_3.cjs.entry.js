...
const AmplifyButton = class {
    constructor(hostRef) {
        ...
        this.handleClick = (ev) => {
            ...
            else if (helpers.hasShadowDom(this.el) && this.type == 'submit') {
    ...
    render() {
        return (index.h("button", { class: {
                [this.variant]: true,
            }, type: this.type, disabled: this.disabled, onClick: this.handleClick }, this.variant === 'icon' && index.h("amplify-icon", { name: this.icon }), index.h("slot", null)));
    }
