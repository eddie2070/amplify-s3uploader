...
const AmplifyTOTPSetup = class {
    ...
    async onTOTPEvent(event, data, user) {
        ...
        if (event === constants.SETUP_TOTP && data === constants.SUCCESS) {
    ...
    async verifyTotpToken(event) {
        ...
        if (!Auth.Auth || typeof Auth.Auth.verifyTotpToken !== 'function' || typeof Auth.Auth.setPreferredMFA !== 'function') {
            throw new Error(constants.NO_AUTH_MODULE_FOUND);
        }
        try {
            ...
            await this.onTOTPEvent(constants.SETUP_TOTP, constants.SUCCESS, user);
        }
        catch (error) {
