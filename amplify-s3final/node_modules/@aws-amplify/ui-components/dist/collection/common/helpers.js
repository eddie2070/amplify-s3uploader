...
import { UI_AUTH_CHANNEL, TOAST_AUTH_ERROR_EVENT, AUTH_STATE_CHANGE_EVENT, PHONE_EMPTY_ERROR_MESSAGE, COUNTRY_DIAL_CODE_SUFFIX, PHONE_SUFFIX, } from './constants';
...
export const composePhoneNumberInput = (phoneNumber) => {
...
export const checkUsernameAlias = (usernameAlias) => {
...
export const onAuthUIStateChange = (authStateHandler) => {
...
export function handlePhoneNumberChange(event, phoneNumber) {
